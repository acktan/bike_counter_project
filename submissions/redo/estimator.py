...
def _merge_external_data(X):
    ...
    X = pd.merge_asof(X.sort_values('date'), df_ext[['date', 't', 'ff', 'u', 'brent', 'holidays', 'curfew', 'rush hour', 'Taux', 'bike', 'Debit']].sort_values('date'), on='date')
...
def get_estimator():
    ...
    binary_cols =  ['curfew']
    numeric_cols = ['Debit', 't', 'bike', 'brent', 'u']
